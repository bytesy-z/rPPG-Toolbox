...
# Number of worker processes for preprocessing (0 = auto-detect CPU cores - 1)
_C.TRAIN.DATA.PREPROCESS.NUM_WORKERS = 0
...
# Number of worker processes for preprocessing (0 = auto-detect CPU cores - 1)
_C.VALID.DATA.PREPROCESS.NUM_WORKERS = 0
...
# Number of worker processes for preprocessing (0 = auto-detect CPU cores - 1)
_C.TEST.DATA.PREPROCESS.NUM_WORKERS = 0
...
# Number of worker processes for preprocessing (0 = auto-detect CPU cores - 1)
_C.UNSUPERVISED.DATA.PREPROCESS.NUM_WORKERS = 0
